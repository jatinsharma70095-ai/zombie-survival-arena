...
export default function ShopScreen() {
  ...
  const handlePurchase = (pkg: typeof PACKAGES[0]) => {
    ...
    // Simulate purchase (no real payment in demo)
      ...
      >
        ...
        >
          ...
          <View style={styles.bannerText}>
            ...
            <Text style={styles.bannerSub}>
              Use diamonds to unlock powerful weapons & keep surviving
            </Text>
          </View>
        </LinearGradient>
        ...
        <View style={styles.notice}>
          ...
          <Text style={styles.noticeText}>
            This is a demo shop. Purchases are simulated and free.
          </Text>
        </View>
          ...
          {PACKAGES.map((pkg) => (
            ...
            >
              ...
              <MaterialCommunityIcons
                name="diamond"
                size={32}
                color={pkg.popular ? Colors.diamond : "#4A9EFF"}
              />
        ...
        <View style={styles.overlay}>
          <View style={styles.successCard}>
            ...
            <View style={styles.successReward}>
              ...
              <Text style={styles.successDiamonds}>
                +{successPkg?.diamonds.toLocaleString()} Diamonds
              </Text>
            </View>
            <Text style={styles.successBalance}>
              New balance: {playerStats.diamonds.toLocaleString()}
            </Text>
            <Pressable
              style={styles.successBtn}
              onPress={() => setSuccessPkg(null)}
            >
